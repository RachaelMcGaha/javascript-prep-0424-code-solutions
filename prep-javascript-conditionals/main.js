...
const isAdultResult = isAdult(47);
...
const didStudentPassResult = didStudentPass(75);
...
const seasonMessengerResults = seasonMessenger('spring');
console.log(seasonMessengerResults);
